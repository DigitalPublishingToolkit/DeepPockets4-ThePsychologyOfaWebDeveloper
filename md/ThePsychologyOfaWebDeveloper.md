...
PATCHWORK CULTURE[^ThePsychologyOfaWebDeveloper_15]
...
too. [^ThePsychologyOfaWebDeveloper_51] Demanding freedom4all seem too naive here. The constraints
...
*https://www.ribbonfarm.com/2018/12/20/why-we-slouch/*.
...
[^ThePsychologyOfaWebDeveloper_1]: Lyrics from ‘Prokleta je Amerika’, by very famous pop-folk singer
    Donna Ares: *https://www.youtube.com/watch?v=qLs6Tqy9Nt0*.

[^ThePsychologyOfaWebDeveloper_2]: IM applications are often standalone applications, such as
...
[^ThePsychologyOfaWebDeveloper_3]: ‘A graphic designer is a professional within the graphic design
...
[^ThePsychologyOfaWebDeveloper_4]: ‘Perhaps the deepest differences emanate from differences in the
...
[^ThePsychologyOfaWebDeveloper_5]: ‘How truly sad it is that just at the very moment when the
    computer has something important to tell us, it starts speaking
    gibberish.’ — Gerald Weinberg, *The Psychology of Computer
    Programming*

[^ThePsychologyOfaWebDeveloper_6]: ‘The other side of the coin of humility is assertiveness, or force
...
[^ThePsychologyOfaWebDeveloper_7]: ‘The job of system design calls for an eye which never loses sight
...
[^ThePsychologyOfaWebDeveloper_8]: In case of a product: worth buying; in case of an artist: worth
    employing; in case of an institution: worth funding.

[^ThePsychologyOfaWebDeveloper_9]: Which the users don’t have the attention span for.

[^ThePsychologyOfaWebDeveloper_10]: For example exchanging website unrelated information such as book
    references, music, event recommendations, etc.

[^ThePsychologyOfaWebDeveloper_11]: ‘Stacktivism is ambivalent and struggles with totality, the
    global scale, and the planetary whatever. “Think big but act in
    small steps,” that’s the motto. We Are Infrastructure. Stacktivism
    fights against the comfort of ignorance and tries hard to overcome
...
[^ThePsychologyOfaWebDeveloper_12]: Profitable for both web-developer and client; web developer can
    charge a lot if the client is guaranteed to receive the funding.

[^ThePsychologyOfaWebDeveloper_13]: ‘The fundamental difference between mass media and digital media
...
[^ThePsychologyOfaWebDeveloper_14]: *Program or be Programmed*, Douglas Rushkoff

[^ThePsychologyOfaWebDeveloper_15]: ‘A patchwork culture of short-term memories and missing records,
    conflicting histories and discontinuous samples, strands of the
    narrative pulled out of time.’ — Sadie Plant, *Zeros and Ones*

[^ThePsychologyOfaWebDeveloper_16]: ‘If the supposed lack of such a central point was once to women’s
...
[^ThePsychologyOfaWebDeveloper_17]: ‘Though details differ, the pattern is depressingly repetitive:
...
[^ThePsychologyOfaWebDeveloper_18]: It seemed to promise a lucrative salary. Most importantly, it
    seemed to be a field too fresh to have a history of creative input
    from an artistic perspective.

[^ThePsychologyOfaWebDeveloper_19]: 1344 EUR

[^ThePsychologyOfaWebDeveloper_20]: ‘Putting a bunch of people to work on the same problem doesn’t
...
[^ThePsychologyOfaWebDeveloper_21]: Ocean Young, *On Earth We’re Briefly Gorgeous*

[^ThePsychologyOfaWebDeveloper_22]: ‘The consumer must never feel completely at home in his present,
    or he will stop striving toward a more fully satisfied future’ —
    Douglas Rushkoff

[^ThePsychologyOfaWebDeveloper_23]: ‘All abstractions are abstractions of nature. To abstract is to
...
[^ThePsychologyOfaWebDeveloper_24]: ‘Anything a female person says or does is open to
...
[^ThePsychologyOfaWebDeveloper_25]: Ana is Anorexia. Similarly Bulimia is Mia, and Eating Disorder
    is, if not otherwise specified, Ednos.

[^ThePsychologyOfaWebDeveloper_26]: The most popular song being ‘She’s falling apart’ by Lisa Loeb
    *https://www.youtube.com/watch?v=FS48eB3NAKI*.

[^ThePsychologyOfaWebDeveloper_27]: For a 177cm tall person, this was bad, it amounts to a BMI of
...
[^ThePsychologyOfaWebDeveloper_28]: ‘He or she in some sense is comfortable because this world is so
...
[^ThePsychologyOfaWebDeveloper_29]: ‘Adolescent sexuality, which employs ignorance as aphrodisiac,
    can become a girl’s deepest experience of Marxian alienation from
    the fruits of her labor: as soon as a girl understands what she is
    doing, she is no longer fit to do it.’ — Elizabeth Wurtzel, *Bitch*

[^ThePsychologyOfaWebDeveloper_30]: ‘For the mainstream thrust of anti-intellectualism, as it stands
...
[^ThePsychologyOfaWebDeveloper_31]: Writing clean code which describes the computer what each text
    component represents; i.e. titles are put in &lt;h1&gt;&lt;/h1&gt;
    tags.

[^ThePsychologyOfaWebDeveloper_32]: Basic tools for building a website.

[^ThePsychologyOfaWebDeveloper_33]: ‘I created one web app in particular, called YouTubeDLD, which (I
    like to claim) is world's best YouTube downloader on the market
    without ads, spam and limitations.’ — My protagonist

[^ThePsychologyOfaWebDeveloper_34]: ‘I recently introduced the Premium version, which allows users to
...
[^ThePsychologyOfaWebDeveloper_35]: ‘We live in a world with multiple timescales, all moving
...
[^ThePsychologyOfaWebDeveloper_36]: ‘Personal content: I feel like they are considered 'smart' when
...
[^ThePsychologyOfaWebDeveloper_37]: The ascendant power over both labor and capital is the
    vectoralist class. It does not control land or industry anymore,
    just information.

[^ThePsychologyOfaWebDeveloper_38]: Its software design feels fun, at first. Guessing the word of the
...
[^ThePsychologyOfaWebDeveloper_39]: ‘The scaling of the economy of gender features most prominently
...
[^ThePsychologyOfaWebDeveloper_40]: ‘The way to flourish in a media space biased toward nonfiction is
    to tell the truth. This means having a truth to tell.’ — Douglas
    Rushkoff, *Program or be Programmed*

[^ThePsychologyOfaWebDeveloper_41]: ‘Information, like land or capital, becomes a form of property
...
[^ThePsychologyOfaWebDeveloper_42]: Ariana Reines, *A Sand Book*, poem: ‘Hegeling before the glass’

[^ThePsychologyOfaWebDeveloper_43]: *https://motherfuckingwebsite.com/*

[^ThePsychologyOfaWebDeveloper_44]: ‘When an uncontainable artist’s influence won’t go away, art
...
[^ThePsychologyOfaWebDeveloper_45]: Hiring a female web developer gives a good image/face to the
...
[^ThePsychologyOfaWebDeveloper_46]: Stars were organized into classes using seven letters: O, B, A,
    F, G, K, and M (abbreviation of Oh! Be a Fine Girl - Kiss Me!).

[^ThePsychologyOfaWebDeveloper_47]: In *Bitch*, Elizabeth Wurtzel describes the men Amy Fisher was
...
[^ThePsychologyOfaWebDeveloper_48]: *https://www.queeringthemap.com/*

[^ThePsychologyOfaWebDeveloper_49]: In the text, Rovelli structures the consistency of modern reality
...
[^ThePsychologyOfaWebDeveloper_50]: *https://silviolorusso.com/publication/learn-to-code-vs-code-to-learn/*

[^ThePsychologyOfaWebDeveloper_51]: In the second episode (‘The Use and Abuse of Vegetational
